#Controllers use chimera instruments to perform actions on chimera
...
### start is a chimera special method.  Runs when you do manager addClass ###
...
### pointVerify is the real controller ###
